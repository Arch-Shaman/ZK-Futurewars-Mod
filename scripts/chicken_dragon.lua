...
local firepoints = {firepoint, spike1, spike2, spike3, firepoint, body}
local rad = math.rad
local bMoving, gun_1
...
local function ShotThread()
	...
	Turn(lforearmu, y_axis, rad(-140), rad(720))
	Turn(lbladeu, y_axis, rad(140), rad(720))
	Turn(lforearml, y_axis, rad(-140), rad(720))
	Turn(lbladel, y_axis, rad(140), rad(720))
	Turn(rforearmu, y_axis, rad(140), rad(720))
	Turn(rbladeu, y_axis, rad(-140), rad(720))
	Turn(rforearml, y_axis, rad(140), rad(720))
	Turn(rbladel, y_axis, rad(-140), rad(720))
	WaitForTurn(rbladel, y_axis)
	
	Turn(lforearmu, y_axis, 0, rad(60))
	Turn(lbladeu, y_axis, 0, rad(60))
	Turn(lforearml, y_axis, 0, rad(60))
	Turn(lbladel, y_axis, 0, rad(60))
	Turn(rforearmu, y_axis, 0, rad(60))
	Turn(rbladeu, y_axis, 0, rad(60))
	Turn(rforearml, y_axis, 0, rad(60))
	Turn(rbladel, y_axis, 0, rad(60))
end
...
local function RestoreAfterDelay()
	Sleep(5000)
	Turn(head, y_axis, rad(0), rad(100))
	Turn(head, x_axis, rad(0), rad(80))
end
