...
local fix_p7 = piece 'fix_p7'
local fix_p15 = piece 'fix_p15'
local fix_p22 = piece 'fix_p22'
local fix_p30 = piece 'fix_p30'
local fix_n7 = piece 'fix_n7'
local fix_n15 = piece 'fix_n15'
local fix_n22 = piece 'fix_n22'
local fix_n30 = piece 'fix_n30'
local rotor_1_1 = piece 'rotor_1_1'
local rotor_1_2 = piece 'rotor_1_2'
local rotor_1_3 = piece 'rotor_1_3'
local rotor_1_4 = piece 'rotor_1_4'
local rotor_2_1 = piece 'rotor_2_1'
local rotor_2_2 = piece 'rotor_2_2'
local rotor_2_3 = piece 'rotor_2_3'
local rotor_2_4 = piece 'rotor_2_4'
...
local HEATRAY_TURNSPEED = math.rad(100)
local HEATRAY_DEVIATION = math.rad(10)
...
function script.Create()
	...
	for i=1, 9 do
		Turn(flamethrowerEmits[i], y_axis, math.rad((-22.5+i*7.5)))
	end
	Turn(rotor_1_1, x_axis, HEATRAY_DEVIATION)
	Turn(rotor_1_2, x_axis, -HEATRAY_DEVIATION)
	Turn(rotor_1_3, y_axis, HEATRAY_DEVIATION)
	Turn(rotor_1_4, y_axis, -HEATRAY_DEVIATION)
	Turn(rotor_2_1, x_axis, HEATRAY_DEVIATION)
	Turn(rotor_2_2, x_axis, -HEATRAY_DEVIATION)
	Turn(rotor_2_3, y_axis, HEATRAY_DEVIATION)
	Turn(rotor_2_4, y_axis, -HEATRAY_DEVIATION)
...
function script.FireWeapon(num)
	if num == 2 then
		for i=1, 10 do
			EmitSfx(heatrayEmits[i], 2049)
			--Spring.Echo("Emitting Flame at Point .. " .. heatrayEmits[i])
		end
	elseif num == 4 then
		for i=1, 9 do
			EmitSfx(flamethrowerEmits[i], 2051)
		end
	elseif num == 3 then
		dgunning = true
		Spring.SetUnitRulesParam(unitID, "selfTurnSpeedChange", 0)
