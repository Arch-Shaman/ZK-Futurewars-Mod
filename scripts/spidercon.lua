...
local function Burrow()
	...
	burrowed = true
	EmitSfx(leg1, dirtfling)
	EmitSfx(leg2, dirtfling)
	EmitSfx(leg3, dirtfling)
	EmitSfx(leg4, dirtfling)
	EmitSfx(leg5, dirtfling)
	EmitSfx(leg6, dirtfling)
	burrowed = true
	
	Move(base, y_axis, 0, 9)
	Turn(base, x_axis, 0, 9)
