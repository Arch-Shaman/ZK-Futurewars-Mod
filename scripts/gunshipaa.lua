...
local gun = {
	...
	[3] = {query = mmissleflare, missile = rmissile, rack = rrack, loaded = true},
	[4] = {query = rmissleflare, missile = lmissile, rack = lrack, loaded = true},
	[5] = {query = lmissleflare, missile = mmissile, rack = mrack, loaded = true},
}
