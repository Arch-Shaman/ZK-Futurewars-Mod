...
local barrels = {
	{larmbarrel1, larmbarrel2, larmbarrel3, rarmbarrel1, rarmbarrel2, rarmbarrel3},
}
local aimpoints = {larmcannon, aaturret, headlaser2, shouldercannon, lfoot, lfoot, lfoot}
