		...
		if cp.numprojectiles1 then
			...
			while cp["numprojectiles" .. submunitionCount] do
				...
				if isRecusive then
					...
					cells = weapons2Table(cells, cp["projectile" .. submunitionCount], unitID, cp["numprojectiles" .. submunitionCount] * (cp.bogus and bombletCount or 1) * cp["clustercharges"],  recursedWepIds)
				end
