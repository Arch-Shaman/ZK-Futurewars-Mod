...
local buildoptions = {
	...
	{-- special
		...
		{ Spring.Utilities.CMD.RAMP,  tech=3 },
		{ Spring.Utilities.CMD.LEVEL,  tech=3 },
		{ Spring.Utilities.CMD.RAISE,  tech=3 },
		{ Spring.Utilities.CMD.SMOOTH,  tech=3 },
		{ Spring.Utilities.CMD.RESTORE,  tech=3 },
		{ Spring.Utilities.CMD.BUMPY,  tech=3 },
...
local globalCommands = {
	--[[{
		id      = Spring.Utilities.CMD.RETREAT_ZONE
...
local overrides = {
	...
	[Spring.Utilities.CMD.RAW_MOVE] = { texture = imageDir .. 'Bold/move.png'},
	...
	[Spring.Utilities.CMD.BUILD] = {caption = '\255\0\255\0B', texture = imageDir .. 'Bold/build.png'},
	...
	[Spring.Utilities.CMD.RAMP] = {texture = imageDir .. 'ramp.png'},
	[Spring.Utilities.CMD.LEVEL] = {texture = imageDir .. 'level.png'},
	[Spring.Utilities.CMD.RAISE] = {texture = imageDir .. 'raise.png'},
	[Spring.Utilities.CMD.SMOOTH] = {texture = imageDir .. 'smooth.png'},
	[Spring.Utilities.CMD.RESTORE] = {texture = imageDir .. 'restore.png'},
	[Spring.Utilities.CMD.BUMPY] = {texture = imageDir .. 'bumpy.png'},

	[Spring.Utilities.CMD.AREA_MEX] = {caption = '', texture = imageDir .. 'Bold/mex.png'},
	[Spring.Utilities.CMD.AREA_TERRA_MEX] = {caption = '', texture = imageDir .. 'Bold/mex.png'},

	[Spring.Utilities.CMD.JUMP] = {texture = imageDir .. 'Bold/jump.png'},
	[Spring.Utilities.CMD.SWEEPFIRE] = {texture = imageDir .. 'sweepfire.png'},
	[Spring.Utilities.CMD.SWEEPFIRE_CANCEL] = {texture = imageDir .. 'sweepfire_cancel.png'},
	[Spring.Utilities.CMD.FIND_PAD] = {caption = '', texture = imageDir .. 'Bold/rearm.png'},

	[Spring.Utilities.CMD.EMBARK] = {caption = '', texture = imageDir .. 'Bold/embark.png'},
	[Spring.Utilities.CMD.DISEMBARK] = {caption = ' ', texture = imageDir .. 'Bold/disembark.png'},

	[Spring.Utilities.CMD.ONECLICK_WEAPON] = {},--texture = imageDir .. 'Bold/action.png'},
	[Spring.Utilities.CMD.UNIT_SET_TARGET] = {texture = imageDir .. 'Bold/action.png'},

	[Spring.Utilities.CMD.ABANDON_PW] = {caption= '', texture = 'LuaUI/Images/Crystal_Clear_action_flag_white.png'},
	[Spring.Utilities.CMD.IMMEDIATETAKEOFF] = {caption = '', texture = 'LuaUI/Images/Commands/takeoff.png'},
	[Spring.Utilities.CMD.PLACE_BEACON] = {caption= '', texture = imageDir .. 'Bold/drop_beacon.png'},

	[Spring.Utilities.CMD.RECALL_DRONES] = {caption= '', texture = imageDir .. 'Bold/recall_drones.png'},

	-- states
	[Spring.Utilities.CMD.WANT_ONOFF] = { texture = {imageDir .. 'states/off.png', imageDir .. 'states/on.png'}, caption=''},
	[Spring.Utilities.CMD.UNIT_AI] = { texture = {imageDir .. 'states/bulb_off.png', imageDir .. 'states/bulb_on.png'}, caption=''},
	...
	[Spring.Utilities.CMD.CLOAK_SHIELD] = { texture = {imageDir .. 'states/areacloak_off.png', imageDir .. 'states/areacloak_on.png'},
		caption ='',	tooltip = 'Area Cloaker State'},
	[Spring.Utilities.CMD.STEALTH] = { texture = {imageDir .. 'states/stealth_off.png', imageDir .. 'states/stealth_on.png'}, caption ='' },
	[Spring.Utilities.CMD.PRIORITY] = { texture = {imageDir .. 'states/wrench_low.png', imageDir .. 'states/wrench_med.png', imageDir .. 'states/wrench_high.png'},
		caption='', tooltip = tooltips.priority},
	[Spring.Utilities.CMD.FACTORY_GUARD] = { texture = {imageDir .. 'states/autoassist_off.png', imageDir .. 'states/autoassist_on.png'},
		caption='', tooltip = tooltips.factoryGuard,},
	[Spring.Utilities.CMD.AUTO_CALL_TRANSPORT] = { texture = {imageDir .. 'states/auto_call_off.png', imageDir .. 'states/auto_call_on.png'},
	...
	[Spring.Utilities.CMD.RETREAT] = { texture = {imageDir .. 'states/retreat_off.png', imageDir .. 'states/retreat_30.png', imageDir .. 'states/retreat_60.png', imageDir .. 'states/retreat_90.png'},
		caption='', tooltip = tooltips.retreat,},
	[Spring.Utilities.CMD.RETREATSHIELD] = { texture = {imageDir .. 'states/shield_off.png', imageDir .. 'states/shield_30.png', imageDir .. 'states/shield_50.png', imageDir .. 'states/shield_80.png'},
		caption='', tooltip = tooltips.retreatshield,},
	[Spring.Utilities.CMD.AUTOJUMP] = { texture = {imageDir .. 'states/autojumpoff.png', imageDir .. 'states/autojumpon.png'}, caption= '', tooltip = tooltips.autojump},
	[Spring.Utilities.CMD.FIRECYCLE] = {texture = {imageDir .. 'states/firecycle_off.png', imageDir .. 'states/firecycle_on.png'}, caption=''},
	[Spring.Utilities.CMD.OVERRECLAIM] = { texture = {imageDir .. 'states/goo_off.png', imageDir .. 'states/goo_on.png'},},
	[CMD.IDLEMODE] = { texture = {imageDir .. 'states/fly_on.png', imageDir .. 'states/fly_off.png'}, caption=''},
	[Spring.Utilities.CMD.AP_FLY_STATE] = { texture = {imageDir .. 'states/fly_on.png', imageDir .. 'states/fly_off.png'}, caption=''},
	...
	[Spring.Utilities.CMD.AP_AUTOREPAIRLEVEL] = { texture = {imageDir .. 'states/landat_off.png', imageDir .. 'states/landat_30.png', imageDir .. 'states/landat_50.png', imageDir .. 'states/landat_80.png'},
		caption = ''},
	[Spring.Utilities.CMD.UNIT_BOMBER_DIVE_STATE] = { texture = {imageDir .. 'states/divebomb_off.png', imageDir .. 'states/divebomb_shield.png', imageDir .. 'states/divebomb_attack.png', imageDir .. 'states/divebomb_always.png'},
		caption = '', tooltip = tooltips.diveBomb,},
	[Spring.Utilities.CMD.UNIT_KILL_SUBORDINATES] = {texture = {imageDir .. 'states/capturekill_off.png', imageDir .. 'states/capturekill_on.png'}, caption=''},
	[Spring.Utilities.CMD.GOO_GATHER] = {texture = {imageDir .. 'states/goo_off.png', imageDir .. 'states/goo_on.png', imageDir .. 'states/goo_cloak.png'}, caption=''},
	[Spring.Utilities.CMD.DISABLE_ATTACK] = {texture = {imageDir .. 'states/disableattack_off.png', imageDir .. 'states/disableattack_on.png'}, caption=''},
	[Spring.Utilities.CMD.PUSH_PULL] = {texture = {imageDir .. 'states/pull_alt.png', imageDir .. 'states/push_alt.png'}, caption=''},
	[Spring.Utilities.CMD.DONT_FIRE_AT_RADAR] = {texture = {imageDir .. 'states/stealth_on.png', imageDir .. 'states/stealth_off.png'}, caption=''},
	[CMD.TRAJECTORY] = { texture = {imageDir .. 'states/traj_low.png', imageDir .. 'states/traj_high.png'}, caption=''},
	[Spring.Utilities.CMD.AIR_STRAFE] = { texture = {imageDir .. 'states/strafe_off.png', imageDir .. 'states/strafe_on.png'}, caption=''},
	[Spring.Utilities.CMD.UNIT_FLOAT_STATE] = { texture = {imageDir .. 'states/amph_sink.png', imageDir .. 'states/amph_attack.png', imageDir .. 'states/amph_float.png'}, caption=''},
	[Spring.Utilities.CMD.SELECTION_RANK] = { texture = {imageDir .. 'states/selection_rank_0.png', imageDir .. 'states/selection_rank_1.png', imageDir .. 'states/selection_rank_2.png', imageDir .. 'states/selection_rank_3.png'}, text=''},
	[Spring.Utilities.CMD.FORMATION_RANK] = { texture = {imageDir .. 'states/formation_rank_0.png', imageDir .. 'states/formation_rank_1.png', imageDir .. 'states/formation_rank_2.png', imageDir .. 'states/formation_rank_3.png'}, text=''},
	[Spring.Utilities.CMD.QUEUE_MODE] = { texture = {imageDir .. 'states/queueoff.png', imageDir .. 'states/queueon.png'}, text=''},
}
