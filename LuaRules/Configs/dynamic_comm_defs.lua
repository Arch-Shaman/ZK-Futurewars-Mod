...
local moduleDefs = {
	...
	},
	{
		...
		image = moduleImagePath .. "module_dronepackage_upgrade.png",
		limit = 1,
		cost = 4000 * COST_MULT, -- was 3k
		requireChassis = {"support"},
		requireLevel = 10, -- was 20
		slotType = "module",
	...
	},
	{
		...
		applicationFunction = function (modules, sharedData)
			...
			sharedData.reloadBonus = (sharedData.reloadBonus or 0) + 0.33
