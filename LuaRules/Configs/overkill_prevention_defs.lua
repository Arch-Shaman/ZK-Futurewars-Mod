...
local handledUnitDefIDs = {
	...
	[UnitDefNames["cloakassault"].id] = 2,
	...
	[UnitDefNames["planeheavyfighter"].id] = 2,
	[UnitDefNames["hoverassault"].id] = 2,
	[UnitDefNames["dronecarrybomber"].id] = 2,
