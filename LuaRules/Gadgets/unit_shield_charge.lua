...
function gadget:GameFrame(n)
	...
	for i = 1, unitCount do
		...
		local maxCharge = spGetUnitRulesParam(unitID, "comm_shield_max") or def.maxCharge
		Spring.Echo("Max shield: " .. tostring(spGetUnitRulesParam(unitID, "comm_shield_max")) .. "\nRegen: " .. tostring(spGetUnitRulesParam(unitID, "comm_shield_recharge")))
		local rechargeRate = spGetUnitRulesParam(unitID, "comm_shield_recharge") or def.chargePerUpdate
		if enabled and charge < maxCharge and not inCooldown and spGetUnitRulesParam(unitID, "shieldChargeDisabled") ~= 1 then
			...
			-- Deal with overflow
			local chargeAdd = newChargeRate*rechargeRate
