...
--  },
	...
	},
	{
		...
		items = {
			...
			{ key = 'Beginner', name = "Chicken: Very Easy", desc = 'Very Easy Chicken.' },
			{ key = 'Very Easy', name = "Chicken: Very Easy", desc = 'Very Easy Chicken.' },
			{ key = 'Easy', name = "Chicken: Easy", desc = 'Easy Chicken.' },
			{ key = 'Normal', name = "Chicken: Normal", desc = 'Normal Chicken.' },
			{ key = 'Hard', name = "Chicken: Hard", desc = 'Hard Chicken.' },
			{ key = 'Suicidal', name = "Chicken: Suicidal", desc = 'Suicidal Chicken.' },
