...
for _, weaponDef in pairs(WeaponDefs) do
	if weaponDef.damage and weaponDef.customparams.featuredamagemult then
		local mult = tonumber(weaponDef.customparams.featuredamagemult) or 1
		local originaldamage = weaponDef.damage.default
		weaponDef.damage.default = originaldamage * mult
		weaponDef.damage["else"] = originaldamage
		weaponDef.damage.shield = weaponDef.damage.shield or originaldamage
		weaponDef.damage.chicken = weaponDef.damage.chicken or originaldamage
		weaponDef.damage.subs = originaldamage -- see above.
		weaponDef.damage.planes = weaponDef.damage.planes or originaldamage
	end
end
