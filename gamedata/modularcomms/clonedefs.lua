...
local copy = {
	...
	commsupport1 = {
		...
		commsupport2 = {
			level = 2,
			mainstats = {maxdamage = 2500, workertime = 20, description = "Econ/Support Commander, Builds at 14 m/s", objectname = "commsupport2.s3o", builddistance = 425, aimposoffset = [[0 17 0]]},
			customparams = {},
			wreckmodel = "commsupport2_dead.s3o",
		},
		commsupport3 = {
			level = 3,
			mainstats = {maxdamage = 3000, workertime = 24, description = "Econ/Support Commander, Builds at 16 m/s", objectname = "commsupport3.s3o", builddistance = 450, aimposoffset = [[0 19 0]],},
			customparams = {},
			wreckmodel = "commsupport3_dead.s3o",
		},
		commsupport4 = {
			level = 4,
			mainstats = {maxdamage = 3700, workertime = 28, description = "Econ/Support Commander, Builds at 18 m/s", objectname = "commsupport4.s3o", builddistance = 475, aimposoffset = [[0 22 0]],},
			customparams = {},
			wreckmodel = "commsupport4_dead.s3o",
		},
		commsupport5 = {
			level = 5,
			mainstats = {maxdamage = 4500, workertime = 32, description = "Econ/Support Commander, Builds at 20 m/s", objectname = "commsupport5.s3o", builddistance = 500, aimposoffset = [[0 25 0]],},
			customparams = {},
	...
	dynsupport1 = {
		...
		dynsupport2 = {
			level = 2,
			mainstats = {objectname = "fwcommsupport2.dae", aimposoffset = [[0 17 0]], builddistance = 425},
			customparams = {shield_emit_height = 39.6},
			wreckmodel = "commsupport2_dead.s3o",
		},
		dynsupport3 = {
			level = 3,
			mainstats = {objectname = "fwcommsupport3.dae", aimposoffset = [[0 19 0]], builddistance = 450},
			customparams = {shield_emit_height = 43.62},
			wreckmodel = "commsupport3_dead.s3o",
		},
		dynsupport4 = {
			level = 4,
			mainstats = {objectname = "fwcommsupport4.dae", aimposoffset = [[0 22 0]], builddistance = 475},
			customparams = {shield_emit_height = 45},
			wreckmodel = "commsupport4_dead.s3o",
		},
		dynsupport5 = {
			level = 5,
			mainstats = {objectname = "fwcommsupport5.dae", aimposoffset = [[0 25 0]], builddistance = 500},
