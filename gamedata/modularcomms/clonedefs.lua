...
local copy = {
	...
	dynsupport1 = {
		...
		dynsupport2 = {
			level = 2,
			mainstats = {objectname = "supportcom2.dae", aimposoffset = [[0 17 0]], builddistance = 425},
		...
		dynsupport3 = {
			level = 3,
			mainstats = {objectname = "supportcom3.dae", aimposoffset = [[0 19 0]], builddistance = 450},
		...
		dynsupport4 = {
			level = 4,
			mainstats = {objectname = "supportcom4.dae", aimposoffset = [[0 22 0]], builddistance = 475},
		...
		dynsupport5 = {
			level = 5,
			mainstats = {objectname = "supportcom5.dae", aimposoffset = [[0 25 0]], builddistance = 500},
