...
local copy = {
	...
	commrecon1 = {
		...
		commrecon2 = {
			level = 2,
			mainstats = {maxdamage = 3300, objectname = "commrecon2.s3o", aimposoffset = [[0 12 0]]},
			customparams = {},
			wreckmodel = "commrecon2_dead.s3o",
		},
		commrecon3 = {
			level = 3,
			mainstats = {maxdamage = 4100, objectname = "commrecon3.s3o", aimposoffset = [[0 14 0]]},
			customparams = {},
			wreckmodel = "commrecon3_dead.s3o",
		},
		commrecon4 = {
			level = 4,
			mainstats = {maxdamage = 4900, objectname = "commrecon4.s3o", aimposoffset = [[0 16 0]]},
			customparams = {},
			wreckmodel = "commrecon4_dead.s3o",
		},
		commrecon5 = {
			level = 5,
			mainstats = {maxdamage = 5700, objectname = "commrecon5.s3o", aimposoffset = [[0 18 0]]},
			customparams = {},
	...
	commsupport1 = {
		...
		commsupport2 = {
			level = 2,
			mainstats = {maxdamage = 2500, workertime = 14, description = "Econ/Support Commander, Builds at 14 m/s", objectname = "commsupport2.s3o", builddistance = 425, aimposoffset = [[0 17 0]]},
			customparams = {},
			wreckmodel = "commsupport2_dead.s3o",
		},
		commsupport3 = {
			level = 3,
			mainstats = {maxdamage = 3000, workertime = 16, description = "Econ/Support Commander, Builds at 16 m/s", objectname = "commsupport3.s3o", builddistance = 450, aimposoffset = [[0 19 0]],},
			customparams = {},
			wreckmodel = "commsupport3_dead.s3o",
		},
		commsupport4 = {
			level = 4,
			mainstats = {maxdamage = 3700, workertime = 18, description = "Econ/Support Commander, Builds at 18 m/s", objectname = "commsupport4.s3o", builddistance = 475, aimposoffset = [[0 22 0]],},
			customparams = {},
			wreckmodel = "commsupport4_dead.s3o",
		},
		commsupport5 = {
			level = 5,
			mainstats = {maxdamage = 4500, workertime = 20, description = "Econ/Support Commander, Builds at 20 m/s", objectname = "commsupport5.s3o", builddistance = 500, aimposoffset = [[0 25 0]],},
			customparams = {},
	...
	dynrecon1 = {
		...
		dynrecon2 = {
			level = 2,
			mainstats = {maxdamage = 3750, objectname = "commrecon2.s3o", aimposoffset = [[0 12 0]]},
			customparams = {shield_emit_height = 33},
			wreckmodel = "commrecon2_dead.s3o",
		},
		dynrecon3 = {
			level = 3,
			mainstats = {maxdamage = 4500, objectname = "commrecon3.s3o", aimposoffset = [[0 14 0]]},
			customparams = {shield_emit_height = 36},
			wreckmodel = "commrecon3_dead.s3o",
		},
		dynrecon4 = {
			level = 4,
			mainstats = {maxdamage = 5250, objectname = "commrecon4.s3o", aimposoffset = [[0 16 0]]},
			customparams = {shield_emit_height = 37.5},
			wreckmodel = "commrecon4_dead.s3o",
		},
		dynrecon5 = {
			level = 5,
			mainstats = {maxdamage = 6000, objectname = "commrecon5.s3o", aimposoffset = [[0 18 0]]},
	...
	dynsupport1 = {
		dynsupport0 = {
			level = 0,
			customparams = {shield_emit_height = 36, builddistance = 425},
		},
		dynsupport2 = {
			level = 2,
			mainstats = {maxdamage = 4750, objectname = "commsupport2.s3o", aimposoffset = [[0 17 0]], builddistance = 425},
			customparams = {shield_emit_height = 39.6},
			wreckmodel = "commsupport2_dead.s3o",
		},
		dynsupport3 = {
			level = 3,
			mainstats = {maxdamage = 5250, objectname = "commsupport3.s3o", aimposoffset = [[0 19 0]], builddistance = 450},
			customparams = {shield_emit_height = 43.62},
			wreckmodel = "commsupport3_dead.s3o",
		},
		dynsupport4 = {
			level = 4,
			mainstats = {maxdamage = 5750, objectname = "commsupport4.s3o", aimposoffset = [[0 22 0]], builddistance = 475},
			customparams = {shield_emit_height = 45},
			wreckmodel = "commsupport4_dead.s3o",
		},
		dynsupport5 = {
			level = 5,
			mainstats = {maxdamage = 6250, objectname = "commsupport5.s3o", aimposoffset = [[0 25 0]], builddistance = 500},
	...
	dynassault1 = {
		...
		dynassault3 = {
			level = 3,
			collisionvolumescales  = [[55 65 55]],
			mainstats = {maxdamage = 3750, objectname = "benzcom3.s3o",},
		...
		dynassault4 = {
			...
			mainstats = {maxdamage = 4500, objectname = "benzcom4.s3o",},
		...
		dynassault5 = {
			...
			mainstats = {maxdamage = 5250, objectname = "benzcom5.s3o",},
