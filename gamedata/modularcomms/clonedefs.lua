...
local copy = {
	...
	dynrecon1 = {
		...
		dynrecon2 = {
			level = 2,
			mainstats = {maxdamage = 4000, objectname = "commrecon2.s3o", aimposoffset = [[0 12 0]]},
			customparams = {shield_emit_height = 33},
			wreckmodel = "commrecon2_dead.s3o",
		},
		dynrecon3 = {
			level = 3,
			mainstats = {maxdamage = 4750, objectname = "commrecon3.s3o", aimposoffset = [[0 14 0]]},
			customparams = {shield_emit_height = 36},
			wreckmodel = "commrecon3_dead.s3o",
		},
		dynrecon4 = {
			level = 4,
			mainstats = {maxdamage = 5500, objectname = "commrecon4.s3o", aimposoffset = [[0 16 0]]},
			customparams = {shield_emit_height = 37.5},
			wreckmodel = "commrecon4_dead.s3o",
		},
		dynrecon5 = {
			level = 5,
			mainstats = {maxdamage = 6250, objectname = "commrecon5.s3o", aimposoffset = [[0 18 0]]},
