...
local copy = {
	...
	dynriot1 = {
		...
		dynriot2 = {
			level = 2,
			mainstats = {maxdamage = 4500, objectname = "corcomAlt2.s3o", aimposoffset = [[0 6 0]], },
			customparams = {damagebonus = "0.05"},
			wreckmodel = "corcom2_dead.s3o",
		},
		dynriot3 = {
			level = 3,
			mainstats = {maxdamage = 6000, objectname = "corcomAlt3.s3o", aimposoffset = [[0 7 0]], },
			customparams = {damagebonus = "0.1"},
			wreckmodel = "corcom3_dead.s3o",
		},
		dynriot4 = {
			level = 4,
			mainstats = {maxdamage = 7500, objectname = "corcomAlt4.s3o", aimposoffset = [[0 8 0]], },
			customparams = {damagebonus = "0.15"},
			wreckmodel = "corcom4_dead.s3o",
		},
		dynriot5 = {
			level = 5,
			mainstats = {maxdamage = 9000, objectname = "corcomAlt5.s3o", aimposoffset = [[0 9 0]], },
			customparams = {damagebonus = "0.20"},
			wreckmodel = "corcom5_dead.s3o",
		},
	},
	dynknight1 = {
