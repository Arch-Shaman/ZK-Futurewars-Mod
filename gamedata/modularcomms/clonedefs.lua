...
local copy = {
	...
	dynsupport1 = {
		...
		dynsupport2 = {
			level = 2,
			mainstats = {maxdamage = 4750, objectname = "commsupport2.s3o", aimposoffset = [[0 17 0]], builddistance = 244},
			customparams = {shield_emit_height = 39.6},
			wreckmodel = "commsupport2_dead.s3o",
		},
		dynsupport3 = {
			level = 3,
			mainstats = {maxdamage = 5250, objectname = "commsupport3.s3o", aimposoffset = [[0 19 0]], builddistance = 256},
			customparams = {shield_emit_height = 43.62},
			wreckmodel = "commsupport3_dead.s3o",
		},
		dynsupport4 = {
			level = 4,
			mainstats = {maxdamage = 5750, objectname = "commsupport4.s3o", aimposoffset = [[0 22 0]], builddistance = 268},
			customparams = {shield_emit_height = 45},
			wreckmodel = "commsupport4_dead.s3o",
		},
		dynsupport5 = {
			level = 5,
			mainstats = {maxdamage = 6250, objectname = "commsupport5.s3o", aimposoffset = [[0 25 0]], builddistance = 280},
