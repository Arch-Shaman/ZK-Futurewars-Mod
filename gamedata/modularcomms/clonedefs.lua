...
local copy = {
	...
	commrecon1 = {
		...
		commrecon2 = {
			level = 2,
			mainstats = {health = 3300, objectname = "commrecon2.s3o", aimposoffset = [[0 12 0]]},
			customparams = {},
			wreckmodel = "commrecon2_dead.s3o",
		},
		commrecon3 = {
			level = 3,
			mainstats = {health = 4100, objectname = "commrecon3.s3o", aimposoffset = [[0 14 0]]},
			customparams = {},
			wreckmodel = "commrecon3_dead.s3o",
		},
		commrecon4 = {
			level = 4,
			mainstats = {health = 4900, objectname = "commrecon4.s3o", aimposoffset = [[0 16 0]]},
			customparams = {},
			wreckmodel = "commrecon4_dead.s3o",
		},
		commrecon5 = {
			level = 5,
			mainstats = {health = 5700, objectname = "commrecon5.s3o", aimposoffset = [[0 18 0]]},
			customparams = {},
	...
	commsupport1 = {
		...
		commsupport2 = {
			level = 2,
			mainstats = {health = 2500, workertime = 20, description = "Econ/Support Commander, Builds at 14 m/s", objectname = "commsupport2.s3o", builddistance = 425, aimposoffset = [[0 17 0]]},
			customparams = {},
			wreckmodel = "commsupport2_dead.s3o",
		},
		commsupport3 = {
			level = 3,
			mainstats = {health = 3000, workertime = 24, description = "Econ/Support Commander, Builds at 16 m/s", objectname = "commsupport3.s3o", builddistance = 450, aimposoffset = [[0 19 0]],},
			customparams = {},
			wreckmodel = "commsupport3_dead.s3o",
		},
		commsupport4 = {
			level = 4,
			mainstats = {health = 3700, workertime = 28, description = "Econ/Support Commander, Builds at 18 m/s", objectname = "commsupport4.s3o", builddistance = 475, aimposoffset = [[0 22 0]],},
			customparams = {},
			wreckmodel = "commsupport4_dead.s3o",
		},
		commsupport5 = {
			level = 5,
			mainstats = {health = 4500, workertime = 32, description = "Econ/Support Commander, Builds at 20 m/s", objectname = "commsupport5.s3o", builddistance = 500, aimposoffset = [[0 25 0]],},
			customparams = {},
