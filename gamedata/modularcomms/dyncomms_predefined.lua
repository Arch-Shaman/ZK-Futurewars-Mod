local ret = {
	dyntrainer_strike = {
		...
		modules = { -- all null because nabs want to personalize
			{"commweapon_heavyrifle", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_heavyrifle", "nullmodule", "nullmodule"},
	...
	dyntrainer_riot = {
		...
		chassis = "riot",
		modules = { -- all null because nabs want to personalize
			{"commweapon_heavymachinegun", "nullmodule"},
			{"commweapon_heavymachinegun", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
	...
	dyntrainer_recon = {
		...
		chassis = "recon",
		modules = { -- all null because nabs want to personalize
			{"commweapon_heatray_recon", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_heatray_recon", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
		},
	...
	dyntrainer_support = {
		...
		chassis = "support",
		modules = { -- all null because nabs want to personalize
			{"commweapon_beamlaser", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_beamlaser", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
		},
	...
	dyntrainer_assault = {
		...
		chassis = "assault",
		modules = { -- all null because nabs want to personalize
			{"commweapon_rocketbarrage", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_rocketbarrage", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
		},
		--decorations = {"banner_overhead"},
