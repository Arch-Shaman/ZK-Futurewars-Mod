...
local resources = {
	graphics = {
      ...
      ----------Spring Effects--------
			...
			yellownovaexplo= "cc/yellownovaexplo.tga",
			greennovaexplo= "Shaman/greennova.tga",
			...
			smoothtrail1= "gpl/smoothtrail.png",
			smoothtrail= "gpl/smoothtrail2.png",
			...
			tracker = "Shaman/lasers/tracker.png",
			bubble = "other/bubble.tga",
			target = "Shaman/targeted.tga",
			spidermonkey = "Shaman/lasers/spidermonkey.png",
			...
			shamanblackhole = "Shaman/blackhole.tga",
