return { 
	bomberprec = {
		...
		customParams        = {
			...
			ammoname_3 = "Heavy Bomb (Armor Piercing)",
		...
		weaponDefs          = {
			...
			TORPEDO = {
				...
				customParams = {
					...
					projectile1 = "bomberprec_torpedoguided",
					clustervec1 = "randomxyz", -- accepted values: randomx, randomy, randomz, randomxy, randomxz, randomyz, random. OPTIONAL. default: random.
					proxy = 0, -- check for nearby units?
					useheight = 1,
					onsplitsound = "sounds/explosion/wet/watersplash.wav",
					spawndist = -1, -- at what distance should we spawn the projectile(s)? REQUIRED.
			...
			TORPEDOGUIDED = {
				...
				soundHitVolume          = 2.8,
				soundStart              = "explosion/wet/watersplash",
				soundStartVolume        = 4,
				startVelocity           = 120,
				tolerance               = 100000,
				tracks                  = true,
