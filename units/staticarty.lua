		...
		weaponDefs                    = {
			PLASMA = {
				...
				customParams            = {
					...
					keepmomentum1 = 1,
					vradius1 = "-3.5,0,-3.5,3.5,0,3.5", -- velocity that is randomly added. covers range of +-vradius. OPTIONAL. Default: 4.2
			...
			PLASMALOWTRAJ = {
				...
				customParams            = {
					light_color = "1.4 0.8 0.3",
					reveal_unit = 14,
					script_reload = "10", --account for around 100% overdrive
					script_burst = "3",
